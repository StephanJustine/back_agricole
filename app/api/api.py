...
from .v1.ia import inferences, modeles, predictions, datasets, recommandations, entrainements
...
api_router.include_router(datasets.router, prefix="/datasets", tags=["IA - Datasets"])
api_router.include_router(entrainements.router, prefix="/entrainements", tags=["IA - Entraînements"])
