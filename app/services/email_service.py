...
class EmailService:
    ...
    @staticmethod
    async def send_reset_password_email(email: str, token: str, nom: str = "", prenom: str = "") -> bool:
        """
    ...
    @staticmethod
    async def send_verification_email(email: str, token: str, nom: str = "", prenom: str = "") -> bool:
        """
        ...
        <body>
            <div class="container">
                <h2>Bienvenue sur Filière Arachide</h2>
                <p>Bonjour {nom} {prenom},</p>
                <p>Merci de vous être inscrit. Pour activer votre compte, cliquez sur le lien ci-dessous :</p>
                <p><a href="{verify_link}" class="button">Vérifier mon email</a></p>
